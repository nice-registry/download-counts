...
The https://npmjs.org/package/download-counts package, updated with a new version once every two months, just exports a single giant static object whose keys are package names and whose values are monthly download counts.
